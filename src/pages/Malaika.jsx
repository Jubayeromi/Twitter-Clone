...
const Malaika = () => {
     const [post, setPost] = useState([]);
      ...
      const MALAIKA_BOARD_URL = 'https://www.pinterest.com/search/pins/?q=malaika%20arora%20hot%20image&rs=typed'; 
      ...
      useEffect(() => {
        ...
        const apiUrl = `http://localhost:5000/api/board/all?url=${encodeURIComponent(MALAIKA_BOARD_URL)}`;
  ...
  return (
    <div>
      <div className="max-w-2xl mx-auto py-4">
        <h1 className="text-2xl font-bold text-center mb-6">Malaika Pins</h1>

        {loading && (
          <div className="text-center py-10 text-gray-400 font-semibold">
            Fetching Malaika Arora images from Pinterest...
          </div>
        )}
