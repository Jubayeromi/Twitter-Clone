...
const Nusrat = () => {
     const [post, setPost] = useState([]);
      ...
      const NUSRAT_BOARD_URL = ['https://www.pinterest.com/search/pins/?q=nusrat%20bharucha%20hot%20images&rs=ac&len=17&source_id=ac_DOLjJN8t&eq=nusrat%20hot%20image&etslf=6382','https://in.pinterest.com/search/pins/?q=nusrat%20bharucha%20in%20high%20heels%20bold%20pics&rs=typed']; 
  ...
  return (
    <div>
      <div className="max-w-2xl mx-auto py-4">
        ...
        <div><button onClick={() => {
          if (index < NUSRAT_BOARD_URL.length - 1) {
            setIndex(index + 1)
            window.scrollTo({
              top: 0,
              behavior: 'smooth'
