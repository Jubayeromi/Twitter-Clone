...
const EshaGupta = () => {
   const [post, setPost] = useState([]);
      ...
      const ESHA_BOARD_URL = 'https://www.pinterest.com/search/pins/?q=esha%20gupta%20hot&rs=typed'; 
      ...
      useEffect(() => {
        ...
        const apiUrl = `http://localhost:5000/api/board/all?url=${encodeURIComponent(ESHA_BOARD_URL)}`;
