...
const Kim = () => {
     ...
     const [post, setPost] = useState([]);
      ...
      const KIM_BOARD_URL = 'https://www.pinterest.com/search/pins/?q=kim%20kardashian%20hot&rs=typed'; 
      ...
      useEffect(() => {
        ...
        const apiUrl = `http://localhost:5000/api/board/all?url=${encodeURIComponent(KIM_BOARD_URL)}`;
